...
public class FileListManagerImpl implements FileListManager {
    ...
    @Override
    public FileList getFileList(String typeCode, String tableType, String tableName, Integer years, Integer months) {
        List<FileList> fileLists = fileListManager.listFileLists(typeCode, tableType, years, months);
    ...
    public List<FileList> listFileLists(String typeCode, String tableType, Integer years, Integer months) {
